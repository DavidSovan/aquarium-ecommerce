          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            {deliveryEnabled && (
              <div className="theme-surface theme-rounded p-5 sm:p-6"
                ...
                <div className="space-y-4">
                  <label className="flex items-center gap-2 cursor-pointer pb-2" style={{ borderBottom: '1px solid color-mix(in srgb, var(--border), transparent 80%)' }}>
                    <input
                      type="checkbox"
                    ...
                    />
                    <span className="text-sm font-semibold theme-text-primary">I want to schedule my delivery (optional)</span>
                  </label>
                  ...
                  {wantSchedule ? (
                    ...
                    <div className="p-3.5 theme-rounded" style={{ backgroundColor: 'color-mix(in srgb, var(--primary) 4%, transparent)', border: '1px dashed color-mix(in srgb, var(--primary) 20%, transparent)' }}>
