...
export function ProductList() {
  ...
  const [form, setForm] = useState({ name: '', price: '', stock_quantity: '', category_id: '', sku: '', short_description: '', description: '', thumbnail: '', brand: '', is_featured: false, is_active: true });
  ...
  const handleEdit = (product) => {
    ...
    setForm({
      ...
      category_id: product.category_id || '', sku: product.sku || '', short_description: product.short_description || '',
      description: product.description || '', thumbnail: product.thumbnail || '', brand: product.brand || '',
  ...
  const resetForm = () => setForm({ name: '', price: '', stock_quantity: '', category_id: '', sku: '', short_description: '', description: '', thumbnail: '', brand: '', is_featured: false, is_active: true });
